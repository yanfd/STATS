...
export default function TreeScene({ season, weather }: TreeSceneProps) {
    // Define darker, gloomier colors based on season
    const getColors = () => {
        switch (season) {
            case 'spring':
                return {
                    leaves: '#4A5D43', // Muted dark green
                    leavesLight: '#6B7F62',
                    trunk: '#3E2723',
                    ground: '#3E423A', // Dark earthy
                    accent: '#8E5E5E' // Muted pinkish
                };
            case 'summer':
                return {
                    leaves: '#1B3A28', // Very deep forest green
                    leavesLight: '#2C4C3B',
                    trunk: '#2D1E1A',
                    ground: '#2F352E', // Dark moss
                    accent: 'transparent'
                };
            case 'autumn':
                return {
                    leaves: '#5D2E2E', // Dark rusty red
                    leavesLight: '#7A4444',
                    trunk: '#3E2723',
                    ground: '#4A3B32', // Dark brown
                    accent: '#8C5E3C'
                };
            case 'winter':
                return {
                    leaves: '#2C3E50', // Dark slate blue (frozen)
                    leavesLight: '#34495E',
                    trunk: '#212121',
                    ground: '#B0BEC5', // Muted grey snow
                    accent: '#ECEFF1' // Snow tips
                };
        }
    };
