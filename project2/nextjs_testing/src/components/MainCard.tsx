...
const MainCard: React.FC = () => {
  ...
  return (
    <div
      ref={cardRef}
      className="tilt-card w-80 h-110 bg-gradient-to-br from-blue-900 to-gray-600 rounded-2xl shadow-2xl relative cursor-pointer transition-transform duration-300 ease-out hover:scale-105" // Use transition-transform
